...
public class GetChanceBillboardAdapter extends BaseQuickAdapter<GetChanceBrandListResponse.Brand, BaseViewHolder> {

    class a extends x0 {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ GetChanceBrandListResponse.BrandJob f84751b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ GetChanceBrandListResponse.Brand f84752c;

        a(GetChanceBrandListResponse.BrandJob brandJob, GetChanceBrandListResponse.Brand brand) {
            this.f84751b = brandJob;
            this.f84752c = brand;
        }

        @Override // com.hpbr.bosszhipin.views.x0
        public void onNoFastClick(View view) {
            new k0(((BaseQuickAdapter) GetChanceBillboardAdapter.this).mContext, this.f84751b.jumpUrl).g();
            com.hpbr.bosszhipin.revision.get.utils.a.b1("1", 2, this.f84752c.brandId, this.f84751b.jobId, "");
        }
    }

    public GetChanceBillboardAdapter() {
        super(q.M5);
    }
