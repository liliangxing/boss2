...
public class EmptyItemFactory implements e<PositionEntity> {

    private class ItemEmptyViewHolder extends BaseChatGroupHolder<PositionEntity> {
        public ItemEmptyViewHolder(Context context, View view) {
            super(context, view);
        }
    ...
    public BaseChatGroupHolder a(Context context, ViewGroup viewGroup) {
        return new ItemEmptyViewHolder(context, LayoutInflater.from(context).inflate(p.f32470xf, (ViewGroup) null));
    }

    @Override // xn.e
    /* JADX INFO: renamed from: c, reason: merged with bridge method [inline-methods] */
    public boolean b(PositionEntity positionEntity) throws ObjectNullPointException {
        return positionEntity.type == 3;
    }
}