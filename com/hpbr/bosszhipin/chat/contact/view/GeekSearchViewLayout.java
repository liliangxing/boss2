...
public class GeekSearchViewLayout extends LinearLayout implements k {
    ...
    public GeekSearchViewLayout(Context context, @Nullable AttributeSet attributeSet) {
    ...
    private void b(Context context) {
        ...
        inputView.setHint("搜索联系人、公司、聊天记录");
    ...
    public GeekSearchViewLayout(Context context, @Nullable AttributeSet attributeSet, int i11) {
