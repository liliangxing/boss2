...
public class r3 extends fd.b {
    ...
    public void e(BaseViewHolder baseViewHolder, ChatBean chatBean, int i11) {
        ...
        if (this.f120666d) {
            ...
            baseViewHolder.convertView.setOnClickListener(new View.OnClickListener() { // from class: com.hpbr.bosszhipin.chat.adapter.provider.q3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ToastUtils.showText("已发送面试结果给牛人");
                }
            });
        }
    }
    ...
    @Override // com.hpbr.bosszhipin.recycleview.a
    public int i() {
        return com.hpbr.bosszhipin.chat.p.f32181ge;
    }
