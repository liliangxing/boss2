...
public class v extends fd.b {
    ...
    class a implements View.OnClickListener {
        ...
        final /* synthetic */ ChatBean f26618b;
        ...
        final /* synthetic */ View f26621e;

        a(ChatBean chatBean, String str, String str2, View view) {
            this.f26618b = chatBean;
            this.f26619c = str;
            this.f26620d = str2;
            this.f26621e = view;
        }
        ...
        public void onClick(View view) {
            if (((fd.b) v.this).f120666d) {
                uk.a.j().a("action-list-f3message-click").o("p", this.f26618b.msgId).p("p2", this.f26618b.hasRead ? "2" : "1").p("p7", this.f26619c).p("p8", this.f26620d).g();
                this.f26621e.setVisibility(8);
                ChatBean chatBean = this.f26618b;
                if (chatBean.hasRead) {
                    return;
                }
                chatBean.hasRead = true;
                nj0.f.r().i(this.f26618b);
            }
        }
    }

    class b extends GestureMTextView.a {

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ URLSpan f26623c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(String str, URLSpan uRLSpan) {
            super(str);
            this.f26623c = uRLSpan;
        }

        @Override // com.hpbr.bosszhipin.views.GestureMTextView.a, android.text.style.ClickableSpan
        public void onClick(View view) {
            ps.k0 k0Var = new ps.k0(v.this.f84490b, this.f26623c.getURL());
            if (k0Var.K() || k0Var.H()) {
                k0Var.g();
            } else {
                nh.v.a(v.this.f84490b, this.f26623c.getURL());
            }
        }
    }
    ...
    private void E(MTextView mTextView) {
        ...
        if (text instanceof Spannable) {
            ...
            for (URLSpan uRLSpan : uRLSpanArr) {
                spannableStringBuilder.setSpan(new b(uRLSpan.getURL(), uRLSpan), spannable.getSpanStart(uRLSpan), spannable.getSpanEnd(uRLSpan), 34);
            }
    ...
    */
    private android.text.SpannableString G(com.hpbr.bosszhipin.module.contacts.entity.protobuf.ChatArticleBean r8, java.lang.String r9) {
        ...
        L8f:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpbr.bosszhipin.chat.adapter.provider.v.G(com.hpbr.bosszhipin.module.contacts.entity.protobuf.ChatArticleBean, java.lang.String):android.text.SpannableString");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void H(ChatBean chatBean, String str, String str2, View view, com.hpbr.bosszhipin.chat.single.listener.w wVar, LinearLayout linearLayout, View view2) {
        if (this.f120666d) {
            uk.a.j().a("action-list-f3message-click").o("p", chatBean.msgId).p("p2", chatBean.hasRead ? "2" : "1").p("p7", str).p("p8", str2).g();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void e(com.hpbr.bosszhipin.recycleview.BaseViewHolder r17, final com.hpbr.bosszhipin.module.contacts.entity.ChatBean r18, int r19) {
        /*
            Method dump skipped, instruction units count: 381
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpbr.bosszhipin.chat.adapter.provider.v.e(com.hpbr.bosszhipin.recycleview.BaseViewHolder, com.hpbr.bosszhipin.module.contacts.entity.ChatBean, int):void");
    }
    ...
    @Override // com.hpbr.bosszhipin.recycleview.a
    public int i() {
        return com.hpbr.bosszhipin.chat.p.L5;
    }
