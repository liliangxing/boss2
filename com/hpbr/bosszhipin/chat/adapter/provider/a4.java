...
public class a4 extends fd.b {
    ...
    public void e(BaseViewHolder baseViewHolder, ChatBean chatBean, int i11) {
        ...
        if (this.f120666d) {
            ...
            mTextView2.setOnClickListener(new View.OnClickListener() { // from class: com.hpbr.bosszhipin.chat.adapter.provider.y3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f26690b.E(chatInterviewBean, view2);
                }
            });
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.hpbr.bosszhipin.chat.adapter.provider.z3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f26711b.F(chatInterviewBean, view2);
                }
            });
        }
    }
    ...
    @Override // com.hpbr.bosszhipin.recycleview.a
    public int i() {
        return com.hpbr.bosszhipin.chat.p.Tc;
    }
