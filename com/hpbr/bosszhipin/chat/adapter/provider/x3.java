...
public class x3 extends fd.b {
    ...
    public void e(BaseViewHolder baseViewHolder, final ChatBean chatBean, int i11) {
        ...
        if (this.f120666d) {
            ...
            baseViewHolder.convertView.setOnClickListener(new View.OnClickListener() { // from class: com.hpbr.bosszhipin.chat.adapter.provider.w3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f26658b.D(chatBean, view);
                }
            });
        }
    }
    ...
    @Override // com.hpbr.bosszhipin.recycleview.a
    public int i() {
        return com.hpbr.bosszhipin.chat.p.Ve;
    }
