...
public class SendRateSatisfactionReasonAdapter extends BaseRvAdapter<ReasonOptionBean, BaseViewHolder> {
    public SendRateSatisfactionReasonAdapter() {
        super(p.C7);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, ReasonOptionBean reasonOptionBean) {
        if (reasonOptionBean == null) {
            return;
        }
        TextView textView = (TextView) baseViewHolder.getView(o.Ap);
        textView.setText(reasonOptionBean.labelDesc);
