...
public class ChatItemMySendQuoteView extends LinearLayout {
    ...
    class a extends x0 {
        ...
        public void onNoFastClick(View view) {
            ...
            PreviewChatMsgActivity.Ue((Activity) ChatItemMySendQuoteView.this.getContext(), PreviewChatMsgActivity.Pe(str, str));
        }
    }
    ...
    class b extends x0 {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ ChatMessageBodyBean f35036b;

        b(ChatMessageBodyBean chatMessageBodyBean) {
            this.f35036b = chatMessageBodyBean;
        }

        @Override // com.hpbr.bosszhipin.views.x0
        public void onNoFastClick(View view) {
            PreviewChatMsgActivity.Ve((Activity) ChatItemMySendQuoteView.this.getContext(), PreviewChatMsgActivity.Re(this.f35036b.text));
        }
    }
    ...
    class c extends x0 {
        ...
        @Override // com.hpbr.bosszhipin.views.x0
        public void onNoFastClick(View view) {
            PreviewChatMsgActivity.Ve((Activity) ChatItemMySendQuoteView.this.getContext(), PreviewChatMsgActivity.Re(this.f35038b));
        }
    }
    ...
    public ChatItemMySendQuoteView(Context context, @Nullable AttributeSet attributeSet) {
    ...
    public void b(@Nullable ChatBean chatBean) {
        ...
        ChatImageInfoBean chatImageInfoBean2;
        removeAllViews();
        if (chatBean == null) {
            View viewInflate = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32384se, (ViewGroup) null);
        ...
        if (chatBean.status == 4) {
            View viewInflate2 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32384se, (ViewGroup) null);
        ...
        if (!LText.empty(chatMessageBodyBean.text)) {
            if (i70.d.e().q(chatBean.f66897message.messageBody.text)) {
                View viewInflate3 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32367re, (ViewGroup) null);
            ...
            View viewInflate4 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32384se, (ViewGroup) null);
        ...
        if (chatMessageBodyBean.sound != null) {
            View viewInflate5 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32350qe, (ViewGroup) null);
        ...
        if (chatDialogBean != null && chatDialogBean.type == 17) {
            View viewInflate6 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32384se, (ViewGroup) null);
        ...
        if (chatGifImageBean != null && (chatImageBean = chatGifImageBean.image) != null && (chatImageInfoBean2 = chatImageBean.originImage) != null) {
            String str = chatImageInfoBean2.url;
            View viewInflate7 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32367re, (ViewGroup) null);
        ...
        if (chatImageBean2 == null || (chatImageInfoBean = chatImageBean2.tinyImage) == null) {
            return;
        }
        String str2 = chatImageInfoBean.url;
        View viewInflate8 = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.f32367re, (ViewGroup) null);
    ...
    public ChatItemMySendQuoteView(Context context, @Nullable AttributeSet attributeSet, int i11) {
