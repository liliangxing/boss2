...
public class QuickHandleWorkCompanyLayout extends LinearLayout {
    ...
    private void a(@Nullable List<ChatUserExperience> list, int i11, ChatUserExperience chatUserExperience, int i12) {
        View viewInflate = LayoutInflater.from(getContext()).inflate(com.hpbr.bosszhipin.chat.p.Af, (ViewGroup) null);
        ...
        ((MTextView) viewInflate.findViewById(com.hpbr.bosszhipin.chat.o.f31724on)).setText(p3.l(StringUtil.COMMON_SEPERATOR, chatUserExperience.organization, chatUserExperience.occupation));
    ...
    private void b(@Nullable List<ChatUserExperience> list) {
        ...
        for (int i11 = 0; i11 < count; i11++) {
            ...
            if (chatUserExperience != null) {
                a(list, i11, chatUserExperience, com.hpbr.bosszhipin.chat.q.f32632z1);
            }
        }
    }
    ...
    private void c(@Nullable ServerGeekCardEduBean serverGeekCardEduBean) {
        if (serverGeekCardEduBean != null) {
            ...
            ImageView imageView2 = (ImageView) viewInflate.findViewById(com.hpbr.bosszhipin.chat.o.f31682nc);
            View viewFindViewById = viewInflate.findViewById(com.hpbr.bosszhipin.chat.o.f31589kc);
            ((MTextView) viewInflate.findViewById(com.hpbr.bosszhipin.chat.o.f31724on)).setText(p3.l(StringUtil.COMMON_SEPERATOR, serverGeekCardEduBean.school, serverGeekCardEduBean.major));
