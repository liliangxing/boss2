...
public class ResumePictureBeanInfo extends BaseResumeData implements a {
    ...
    public ResumePictureBeanInfo(ServerDesignWorksGroupBean serverDesignWorksGroupBean, int i11, List<ServerDesignWorksGroupBean> list) {
        super(104);
