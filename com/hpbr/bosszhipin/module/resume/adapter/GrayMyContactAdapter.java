...
public class GrayMyContactAdapter extends LinkExpandAdapter<ServerRemarkBean, BaseViewHolder> {
    public GrayMyContactAdapter(@Nullable List<ServerRemarkBean> list) {
        super(h.Ij, list);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, ServerRemarkBean serverRemarkBean) {
        ...
        view2.setVisibility(s(adapterPosition) ? 4 : 0);
        ...
        if (adapterPosition == 0) {
            mTextView.setTextColor(ContextCompat.getColor(this.mContext, d.O2));
