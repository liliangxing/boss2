...
public class SkillGroupItemView2 extends FrameLayout {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @NonNull
    private final A f76183b;
    ...
    private static class A extends BaseRvAdapter<SubLevelModelListBean, BaseViewHolder> {
        ...
        public void convert(@NonNull BaseViewHolder baseViewHolder, SubLevelModelListBean subLevelModelListBean) {
            ...
            if (subLevelModelListBean.isCustomize) {
                linearLayout.setBackgroundResource(ba.f.f3090f0);
    ...
    class b implements BaseQuickAdapter.OnItemChildClickListener {
        ...
        public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i11) {
            SubLevelModelListBean item = SkillGroupItemView2.this.f76183b.getItem(i11);
            int id2 = view.getId();
            if (id2 != ba.g.Eh) {
                ...
                if (item.isCustomize) {
                    if (SkillGroupItemView2.this.f76184c != null) {
                        SkillGroupItemView2.this.f76184c.d();
                        return;
                    }
                    return;
                } else {
                    if (SkillGroupItemView2.this.f76184c != null) {
                        SkillGroupItemView2.this.f76184c.b(item);
            ...
            if (item != null) {
                ...
                if (item.flag == 1) {
                    item.flag = 0;
                    if (SkillGroupItemView2.this.f76184c != null) {
                        SkillGroupItemView2.this.f76184c.a(item);
                    }
                } else if (SkillGroupItemView2.this.f76184c != null && SkillGroupItemView2.this.f76184c.c(item)) {
                    item.flag = 1;
                }
                SkillGroupItemView2.this.f76183b.notifyDataSetChanged();
            }
        }
    }

    public SkillGroupItemView2(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public void setSkills(@NonNull List<SubLevelModelListBean> list) {
        this.f76183b.getData().clear();
        this.f76183b.getData().addAll(list);
        this.f76183b.notifyDataSetChanged();
    }
    ...
    public SkillGroupItemView2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i11) {
