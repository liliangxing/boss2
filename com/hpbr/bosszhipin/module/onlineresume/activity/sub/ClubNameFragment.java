...
public class ClubNameFragment extends BaseSingleInputFragment {

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private String f74794q;
    ...
    public static void yg(Fragment fragment, Context context, int i11, String str) {
        ...
        if (fragment == null) {
            SubPageTransferActivity.Ue(context, ClubNameFragment.class, bundle, i11);
        } else {
            SubPageTransferActivity.bf(fragment, context, ClubNameFragment.class, bundle, i11);
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (arguments != null) {
            this.f74794q = arguments.getString(com.hpbr.bosszhipin.config.b.f43164y0, "");
        }
    }
