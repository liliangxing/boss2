...
public class StuF1DistrictSelectParams extends BaseEntity {
    ...
    public static StuF1DistrictSelectParams obj() {
        return new StuF1DistrictSelectParams();
    }
    ...
    public StuF1DistrictSelectParams setJobIntent(JobIntentBean jobIntentBean) {
        this.mCurExpectJobForGeek = jobIntentBean;
        return this;
    }

    public StuF1DistrictSelectParams setSelectDistrictData(LevelBean levelBean) {
        this.mSelectedDistrictData = levelBean;
        return this;
    }

    public StuF1DistrictSelectParams setSelectSubwayData(LevelBean levelBean) {
