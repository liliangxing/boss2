...
public class OffInterceptCloseEventAction extends BZWebAction<ZpPostMessage> {
    public OffInterceptCloseEventAction(@NonNull j0 j0Var) {
        super(j0Var);
    }

    @Override // com.hpbr.bosszhipin.module.webview.jsi.BZWebAction
    public void handle(@NonNull ZpPostMessage zpPostMessage) {
        getWebViewCommon().updateInterceptCloseEvent(false);
    }
