...
public class GetPublishSuccessAdapter extends BaseRvAdapter<ServerJobItemBean, BaseViewHolder> {
    public GetPublishSuccessAdapter(@Nullable List<ServerJobItemBean> list) {
        super(q.G6, list);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, ServerJobItemBean serverJobItemBean) {
        ...
        int i13 = p.f50088oq;
        gone2.setGone(i13, !LText.isEmptyOrNull(serverJobItemBean.degreeName)).setText(i13, serverJobItemBean.degreeName);
    }
}