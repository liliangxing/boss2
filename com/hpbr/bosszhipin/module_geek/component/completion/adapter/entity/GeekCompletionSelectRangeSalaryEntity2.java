...
public class GeekCompletionSelectRangeSalaryEntity2 extends GeekCompletionSelectRangeBaseEntity {
    ...
    public GeekCompletionSelectRangeSalaryEntity2(int i11, int i12, @Nullable GetSalarySuggestResponse getSalarySuggestResponse, @NonNull GeekCompletionExpectStorageBean geekCompletionExpectStorageBean, c cVar) {
        super(62);
        this.lowSalary = i11;
        this.highSalary = i12;
        this.listener = cVar;
