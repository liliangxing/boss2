...
public class GeekTextPlayAdater extends BaseRvAdapter<LineText, BaseViewHolder> {
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, LineText lineText) {
        int i11 = h.Xq;
        ((AutoWrapTextView) baseViewHolder.getView(i11)).f(TextUtils.isEmpty(lineText.line) ? TimeUtils.PATTERN_SPLIT : lineText.line, Color.parseColor((this.f83849d == baseViewHolder.getAdapterPosition()) && (!lineText.isQuestion || this.f83848c) ? "#ffffffff" : "#77ffffff"), true, Scale.dip2px(baseViewHolder.itemView.getContext(), (!lineText.isQuestion || this.f83848c) ? 28.0f : 18.0f));
