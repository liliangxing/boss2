...
public class b0 extends AbsPage {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @Nullable
    private View f81300b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @Nullable
    private Runnable f81301c;

    class a extends x0 {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ x0 f81302b;
        ...
        public void onNoFastClick(View view) {
            this.f81302b.onNoFastClick(view);
        }
    }

    public b0(AbsPage.InitParams initParams) {
        super(initParams);
    }
    ...
    public void a(@NonNull ViewGroup viewGroup, @NonNull x0 x0Var, @NonNull Runnable runnable, @NonNull Runnable runnable2) {
        ...
        this.f81301c = runnable;
        View viewInflate = LayoutInflater.from(viewGroup.getContext()).inflate(l10.i.f129059t7, viewGroup, false);
        View viewFindViewById = viewInflate.findViewById(l10.h.f128013bp);
        this.f81300b = viewFindViewById;
    ...
    @Override // com.hpbr.bosszhipin.module_geek.component.backflow.z
    public void c() {
        Runnable runnable = this.f81301c;
        if (runnable != null) {
            runnable.run();
            this.f81301c = null;
        }
