...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ View f91660b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f91661c;
        ...
        public void run() {
            ViewPagerBottomSheetBehavior.this.startSettlingAnimation(this.f91660b, this.f91661c);
        }
    }
    ...
    private class c implements Runnable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final View f91663b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final int f91664c;
        ...
        public void run() {
            ...
            if (viewDragHelper == null || !viewDragHelper.continueSettling(true)) {
                ViewPagerBottomSheetBehavior.this.setStateInternal(this.f91664c);
            } else {
                ViewCompat.postOnAnimation(this.f91663b, this);
            }
        }
    }
    ...
    public ViewPagerBottomSheetBehavior() {
        ...
        this.mState = 4;
        this.mDragCallback = new ViewDragHelper.Callback() { // from class: com.hpbr.bosszhipin.views.behavior.ViewPagerBottomSheetBehavior.2
            ...
            public int clampViewPositionVertical(View view, int i11, int i12) {
                ...
                return MathUtils.clamp(i11, viewPagerBottomSheetBehavior.mMinOffset, viewPagerBottomSheetBehavior.mHideable ? viewPagerBottomSheetBehavior.mParentHeight : viewPagerBottomSheetBehavior.mMaxOffset);
            }
            ...
            public int getViewVerticalDragRange(View view) {
                ...
                if (viewPagerBottomSheetBehavior.mHideable) {
                    i11 = viewPagerBottomSheetBehavior.mParentHeight;
                    i12 = viewPagerBottomSheetBehavior.mMinOffset;
                } else {
                    i11 = viewPagerBottomSheetBehavior.mMaxOffset;
                    i12 = viewPagerBottomSheetBehavior.mMinOffset;
                }
                return i11 - i12;
            }
            ...
            public void onViewReleased(View view, float f11, float f12) {
                ...
                int i12 = 3;
                if (f12 < 0.0f) {
                    i11 = ViewPagerBottomSheetBehavior.this.mMinOffset;
                } else {
                    ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior = ViewPagerBottomSheetBehavior.this;
                    if (viewPagerBottomSheetBehavior.mHideable && viewPagerBottomSheetBehavior.shouldHide(view, f12)) {
                        i11 = ViewPagerBottomSheetBehavior.this.mParentHeight;
                        i12 = 5;
                    } else {
                        if (f12 == 0.0f) {
                            int top2 = view.getTop();
                            if (Math.abs(top2 - ViewPagerBottomSheetBehavior.this.mMinOffset) < Math.abs(top2 - ViewPagerBottomSheetBehavior.this.mMaxOffset)) {
                                i11 = ViewPagerBottomSheetBehavior.this.mMinOffset;
                            } else {
                                i11 = ViewPagerBottomSheetBehavior.this.mMaxOffset;
                            }
                        } else {
                            i11 = ViewPagerBottomSheetBehavior.this.mMaxOffset;
                        }
                ...
                if (!ViewPagerBottomSheetBehavior.this.mViewDragHelper.settleCapturedViewAt(view.getLeft(), i11)) {
                    ViewPagerBottomSheetBehavior.this.setStateInternal(i12);
                } else {
            ...
            public boolean tryCaptureView(View view, int i11) {
                ...
                View view2;
                ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior = ViewPagerBottomSheetBehavior.this;
                int i12 = viewPagerBottomSheetBehavior.mState;
                if (i12 == 1 || viewPagerBottomSheetBehavior.mTouchingScrollingChild) {
                    return false;
                }
                return ((i12 == 3 && viewPagerBottomSheetBehavior.mActivePointerId == i11 && (view2 = viewPagerBottomSheetBehavior.mNestedScrollingChildRef.get()) != null && view2.canScrollVertically(-1)) || (weakReference = ViewPagerBottomSheetBehavior.this.mViewRef) == null || weakReference.get() != view) ? false : true;
            }
        };
    }

    public static <V extends View> ViewPagerBottomSheetBehavior<V> from(V v11) {
    ...
    */
    public final void setPeekHeight(int r4) {
        ...
        L3a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpbr.bosszhipin.views.behavior.ViewPagerBottomSheetBehavior.setPeekHeight(int):void");
    }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f91659b = parcel.readInt();
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i11) {
            super.writeToParcel(parcel, i11);
            parcel.writeInt(this.f91659b);
        }
    ...
    public ViewPagerBottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.mDragCallback = new ViewDragHelper.Callback() { // from class: com.hpbr.bosszhipin.views.behavior.ViewPagerBottomSheetBehavior.2
            ...
            public int clampViewPositionVertical(View view, int i112, int i12) {
                ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior = ViewPagerBottomSheetBehavior.this;
                return MathUtils.clamp(i112, viewPagerBottomSheetBehavior.mMinOffset, viewPagerBottomSheetBehavior.mHideable ? viewPagerBottomSheetBehavior.mParentHeight : viewPagerBottomSheetBehavior.mMaxOffset);
            }
            ...
            public int getViewVerticalDragRange(View view) {
                ...
                ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior = ViewPagerBottomSheetBehavior.this;
                if (viewPagerBottomSheetBehavior.mHideable) {
                    i112 = viewPagerBottomSheetBehavior.mParentHeight;
                    i12 = viewPagerBottomSheetBehavior.mMinOffset;
                } else {
                    i112 = viewPagerBottomSheetBehavior.mMaxOffset;
                    i12 = viewPagerBottomSheetBehavior.mMinOffset;
                }
                return i112 - i12;
            }
            ...
            public void onViewReleased(View view, float f11, float f12) {
                ...
                int i12 = 3;
                if (f12 < 0.0f) {
                    i112 = ViewPagerBottomSheetBehavior.this.mMinOffset;
                } else {
                    ViewPagerBottomSheetBehavior viewPagerBottomSheetBehavior = ViewPagerBottomSheetBehavior.this;
                    if (viewPagerBottomSheetBehavior.mHideable && viewPagerBottomSheetBehavior.shouldHide(view, f12)) {
                        i112 = ViewPagerBottomSheetBehavior.this.mParentHeight;
                        i12 = 5;
                    } else {
                        if (f12 == 0.0f) {
                            int top2 = view.getTop();
                            if (Math.abs(top2 - ViewPagerBottomSheetBehavior.this.mMinOffset) < Math.abs(top2 - ViewPagerBottomSheetBehavior.this.mMaxOffset)) {
                                ...
                                i112 = ViewPagerBottomSheetBehavior.this.mMaxOffset;
                            }
                        } else {
                            i112 = ViewPagerBottomSheetBehavior.this.mMaxOffset;
                        }
                ...
                if (!ViewPagerBottomSheetBehavior.this.mViewDragHelper.settleCapturedViewAt(view.getLeft(), i112)) {
                    ViewPagerBottomSheetBehavior.this.setStateInternal(i12);
                } else {
                    ViewPagerBottomSheetBehavior.this.setStateInternal(2);
                    ViewCompat.postOnAnimation(view, new c(view, i12));
            ...
            public boolean tryCaptureView(View view, int i112) {
                ...
                return ((i12 == 3 && viewPagerBottomSheetBehavior.mActivePointerId == i112 && (view2 = viewPagerBottomSheetBehavior.mNestedScrollingChildRef.get()) != null && view2.canScrollVertically(-1)) || (weakReference = ViewPagerBottomSheetBehavior.this.mViewRef) == null || weakReference.get() != view) ? false : true;
            }
        };
