...
public class MultiAddressSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ View f91652b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f91653c;
        ...
        public void run() {
            MultiAddressSheetBehavior.this.startSettlingAnimation(this.f91652b, this.f91653c);
        }
    }
    ...
    private class c implements Runnable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final View f91655b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final int f91656c;
        ...
        @Override // java.lang.Runnable
        public void run() {
            ViewDragHelper viewDragHelper = MultiAddressSheetBehavior.this.mViewDragHelper;
            if (viewDragHelper == null || !viewDragHelper.continueSettling(true)) {
                MultiAddressSheetBehavior.this.setStateInternal(this.f91656c);
            } else {
                ViewCompat.postOnAnimation(this.f91655b, this);
            }
        }
    }

    public MultiAddressSheetBehavior() {
        this.HIDE_THRESHOLD = 0.5f;
        this.mState = 4;
        this.mDragCallback = new ViewDragHelper.Callback() { // from class: com.hpbr.bosszhipin.views.behavior.MultiAddressSheetBehavior.2
            ...
            public int clampViewPositionVertical(View view, int i11, int i12) {
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                return MathUtils.clamp(i11, multiAddressSheetBehavior.mMinOffset, multiAddressSheetBehavior.mHideable ? multiAddressSheetBehavior.mParentHeight : multiAddressSheetBehavior.mMaxOffset);
            }
            ...
            public int getViewVerticalDragRange(View view) {
                ...
                int i12;
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                if (multiAddressSheetBehavior.mHideable) {
                    i11 = multiAddressSheetBehavior.mParentHeight;
                    i12 = multiAddressSheetBehavior.mMinOffset;
                } else {
                    i11 = multiAddressSheetBehavior.mMaxOffset;
                    i12 = multiAddressSheetBehavior.mMinOffset;
                }
                return i11 - i12;
            }
            ...
            public void onViewDragStateChanged(int i11) {
                if (i11 == 1) {
                    MultiAddressSheetBehavior.this.setStateInternal(1);
                }
            }

            @Override // androidx.customview.widget.ViewDragHelper.Callback
            public void onViewPositionChanged(View view, int i11, int i12, int i13, int i14) {
                MultiAddressSheetBehavior.this.dispatchOnSlide(i12);
            }
            ...
            public void onViewReleased(View view, float f11, float f12) {
                ...
                int i12;
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                if (multiAddressSheetBehavior.mHideable && multiAddressSheetBehavior.shouldHide(view, f12)) {
                    i11 = MultiAddressSheetBehavior.this.mParentHeight;
                    i12 = 5;
                } else {
                    int top2 = view.getTop();
                    MultiAddressSheetBehavior multiAddressSheetBehavior2 = MultiAddressSheetBehavior.this;
                    int i13 = multiAddressSheetBehavior2.mParentHeight;
                    if ((top2 <= (i13 * 3) / 4 && top2 >= i13 / 2) || (top2 < i13 / 2 && top2 >= i13 / 4)) {
                        i11 = i13 / 2;
                        i12 = 6;
                    } else if (top2 < i13 / 4) {
                        i11 = multiAddressSheetBehavior2.mMinOffset;
                        i12 = 3;
                    } else {
                        i11 = top2 > (i13 * 3) / 4 ? multiAddressSheetBehavior2.mMaxOffset : 0;
                        i12 = 4;
                    }
                }
                if (!MultiAddressSheetBehavior.this.mViewDragHelper.settleCapturedViewAt(view.getLeft(), i11)) {
                    MultiAddressSheetBehavior.this.setStateInternal(i12);
                } else {
                    MultiAddressSheetBehavior.this.setStateInternal(2);
            ...
            public boolean tryCaptureView(View view, int i11) {
                ...
                View view2;
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                int i12 = multiAddressSheetBehavior.mState;
                if (i12 == 1 || multiAddressSheetBehavior.mTouchingScrollingChild) {
                    return false;
                }
                return ((i12 == 3 && multiAddressSheetBehavior.mActivePointerId == i11 && (view2 = multiAddressSheetBehavior.mNestedScrollingChildRef.get()) != null && view2.canScrollVertically(-1)) || (weakReference = MultiAddressSheetBehavior.this.mViewRef) == null || weakReference.get() != view) ? false : true;
            }
        };
    }

    public static <V extends View> MultiAddressSheetBehavior<V> from(V v11) {
        ViewGroup.LayoutParams layoutParams = v11.getLayoutParams();
        if (!(layoutParams instanceof CoordinatorLayout.LayoutParams)) {
            throw new IllegalArgumentException("The view is not a child of CoordinatorLayout");
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) layoutParams).getBehavior();
        if (behavior instanceof MultiAddressSheetBehavior) {
            return (MultiAddressSheetBehavior) behavior;
        }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v11, int i11) {
        ...
        if (i12 == 3) {
            ...
            ViewCompat.offsetTopAndBottom(v11, this.mParentHeight / 2);
        }
    ...
    */
    public final void setPeekHeight(int r4) {
        ...
        L3a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpbr.bosszhipin.views.behavior.MultiAddressSheetBehavior.setPeekHeight(int):void");
    }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f91651b = parcel.readInt();
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i11) {
            super.writeToParcel(parcel, i11);
            parcel.writeInt(this.f91651b);
        }
    ...
    public MultiAddressSheetBehavior(Context context, AttributeSet attributeSet) {
        int i11;
        ...
        this.mDragCallback = new ViewDragHelper.Callback() { // from class: com.hpbr.bosszhipin.views.behavior.MultiAddressSheetBehavior.2
            ...
            public int clampViewPositionVertical(View view, int i112, int i12) {
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                return MathUtils.clamp(i112, multiAddressSheetBehavior.mMinOffset, multiAddressSheetBehavior.mHideable ? multiAddressSheetBehavior.mParentHeight : multiAddressSheetBehavior.mMaxOffset);
            }
            ...
            public int getViewVerticalDragRange(View view) {
                ...
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                if (multiAddressSheetBehavior.mHideable) {
                    i112 = multiAddressSheetBehavior.mParentHeight;
                    i12 = multiAddressSheetBehavior.mMinOffset;
                } else {
                    i112 = multiAddressSheetBehavior.mMaxOffset;
                    i12 = multiAddressSheetBehavior.mMinOffset;
                }
                return i112 - i12;
            }
            ...
            public void onViewReleased(View view, float f11, float f12) {
                ...
                MultiAddressSheetBehavior multiAddressSheetBehavior = MultiAddressSheetBehavior.this;
                if (multiAddressSheetBehavior.mHideable && multiAddressSheetBehavior.shouldHide(view, f12)) {
                    i112 = MultiAddressSheetBehavior.this.mParentHeight;
                    i12 = 5;
                } else {
                    int top2 = view.getTop();
                    MultiAddressSheetBehavior multiAddressSheetBehavior2 = MultiAddressSheetBehavior.this;
                    ...
                    if ((top2 <= (i13 * 3) / 4 && top2 >= i13 / 2) || (top2 < i13 / 2 && top2 >= i13 / 4)) {
                        ...
                        i112 = multiAddressSheetBehavior2.mMinOffset;
                        i12 = 3;
                    } else {
                        i112 = top2 > (i13 * 3) / 4 ? multiAddressSheetBehavior2.mMaxOffset : 0;
                        i12 = 4;
                    }
                }
                if (!MultiAddressSheetBehavior.this.mViewDragHelper.settleCapturedViewAt(view.getLeft(), i112)) {
                    MultiAddressSheetBehavior.this.setStateInternal(i12);
                } else {
                    MultiAddressSheetBehavior.this.setStateInternal(2);
                    ViewCompat.postOnAnimation(view, new c(view, i12));
            ...
            public boolean tryCaptureView(View view, int i112) {
                ...
                return ((i12 == 3 && multiAddressSheetBehavior.mActivePointerId == i112 && (view2 = multiAddressSheetBehavior.mNestedScrollingChildRef.get()) != null && view2.canScrollVertically(-1)) || (weakReference = MultiAddressSheetBehavior.this.mViewRef) == null || weakReference.get() != view) ? false : true;
            }
        };
