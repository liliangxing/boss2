...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i11) {
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: com.hpbr.bosszhipin.views.banner.util.ScrollSpeedManger.1
            @Override // androidx.recyclerview.widget.LinearSmoothScroller
            protected int calculateTimeForDeceleration(int i12) {
                return ScrollSpeedManger.this.f91638b.getScrollTime();
            }
        };
