...
public class BlockChatKeyAdapter extends BaseQuickAdapter<ServerGoodsInfoBean, BaseViewHolder> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private ServerGoodsInfoBean f21987b;

    public BlockChatKeyAdapter(@Nullable List<ServerGoodsInfoBean> list) {
        super(g.W5, list);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, ServerGoodsInfoBean serverGoodsInfoBean) {
        if (serverGoodsInfoBean != null) {
            ...
            ServerGoodsInfoBean serverGoodsInfoBean2 = this.f21987b;
    ...
    void j(ServerGoodsInfoBean serverGoodsInfoBean) {
        this.f21987b = serverGoodsInfoBean;
    }
}