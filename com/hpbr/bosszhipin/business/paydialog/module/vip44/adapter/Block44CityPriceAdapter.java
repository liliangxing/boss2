...
public class Block44CityPriceAdapter extends BaseQuickAdapter<ServerPrivilegePriceBean, BaseViewHolder> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @Nullable
    private ServerPrivilegePriceBean f25347b;

    public Block44CityPriceAdapter(List<ServerPrivilegePriceBean> list) {
        super(g.H1, list);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, ServerPrivilegePriceBean serverPrivilegePriceBean) {
        ...
        ServerPrivilegePriceBean serverPrivilegePriceBean2 = this.f25347b;
    ...
    public void h(@Nullable ServerPrivilegePriceBean serverPrivilegePriceBean) {
        this.f25347b = serverPrivilegePriceBean;
