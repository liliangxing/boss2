...
public class BaseLiveRefreshHeader extends LinearLayout implements vf0.d {
    public BaseLiveRefreshHeader(Context context) {
        super(context);
    }
    ...
    public BaseLiveRefreshHeader(Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public BaseLiveRefreshHeader(Context context, @Nullable AttributeSet attributeSet, int i11) {
