...
public class PosterInfoAdapter extends BaseRvAdapter<PosterInfoBean, BaseViewHolder> {
    public PosterInfoAdapter() {
        super(f.J);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, PosterInfoBean posterInfoBean) {
        ...
        View view = baseViewHolder.getView(e.Qs);
        ...
        view.setVisibility(baseViewHolder.getAdapterPosition() == LList.getCount(getData()) + (-1) ? 8 : 0);
    }
}