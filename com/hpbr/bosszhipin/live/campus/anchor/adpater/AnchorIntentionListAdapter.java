...
public class AnchorIntentionListAdapter extends BaseRvAdapter<IntentionRankBean, BaseViewHolder> {
    public AnchorIntentionListAdapter() {
        super(f.f146776k7);
    }
    ...
    public void convert(@NonNull BaseViewHolder baseViewHolder, IntentionRankBean intentionRankBean) {
        ...
        textView2.setTextColor(ContextCompat.getColor(this.mContext, intentionRankBean.isLeaveASeat ? b.f145682i0 : b.Q));
