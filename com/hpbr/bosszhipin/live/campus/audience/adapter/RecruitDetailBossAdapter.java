...
public class RecruitDetailBossAdapter extends BaseRvAdapter<RecruitDetailTabResponse.BossBean, BaseViewHolder> {
    public RecruitDetailBossAdapter(List<RecruitDetailTabResponse.BossBean> list) {
        super(f.O7, list);
    }
