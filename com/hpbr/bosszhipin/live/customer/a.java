...
public class a implements h {
    ...
    /* JADX INFO: renamed from: com.hpbr.bosszhipin.live.customer.a$a, reason: collision with other inner class name */
    class C0423a implements com.hpbr.bosszhipin.utils.permission.d<com.hpbr.bosszhipin.utils.permission.e> {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ nf0.f f62275a;
    ...
    public void a(@NonNull i iVar, @NonNull nf0.f fVar) {
        ...
        if (fragmentActivity != null) {
            PermissionHelper.r(fragmentActivity).R(new C0423a(fVar)).O();
        } else {
            TLog.error("AnchorPermissionInterceptor", "当前 Context 异常 context = %s", contextB);
            fVar.onComplete(200);
        }
    }
}