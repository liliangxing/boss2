...
import com.hpbr.bosszhipin.live.boss.reservation.fragment.ReservePreachBasicFragment;
...
public class ReservePreachActivity extends BaseAwareActivity<ReservePreachViewModel> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private boolean f57474b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private List<JobsBean> f57475c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private long f57476d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private ReservePreachBasicFragment f57477e;

    /* JADX INFO: Access modifiers changed from: private */
    public void Af(int i11, BaseFragment baseFragment, String str, boolean z11) {
    ...
    private void initData() {
        RecordDetailForModifyResponse recordDetailForModifyResponseB;
        M m11 = this.mViewModel;
        if (((ReservePreachViewModel) m11).f58293s) {
            ((ReservePreachViewModel) m11).f58295u = false;
        }
        if (hp.a.b(Integer.parseInt("2")) != null && com.hpbr.bosszhipin.live.util.l.c() != null) {
            hp.a.d(com.hpbr.bosszhipin.live.util.l.c());
        }
        if (((ReservePreachViewModel) this.mViewModel).f58295u && (recordDetailForModifyResponseB = hp.a.b(Integer.parseInt("2"))) != null) {
        ...
        if (com.hpbr.bosszhipin.live.util.l.c() != null) {
            ((ReservePreachViewModel) this.mViewModel).U(this.f57474b, com.hpbr.bosszhipin.live.util.l.c(), this.f57476d, this.f57475c);
            return;
        }
        int intExtra = getIntent() != null ? getIntent().getIntExtra("intent_create_bzp_type", -1) : -1;
        M m12 = this.mViewModel;
        ((ReservePreachViewModel) m12).S(((ReservePreachViewModel) m12).f58291q, this.f57474b, this.f57476d, this.f57475c, intExtra);
    }
    ...
    private void initIntent() {
        ...
        this.f57474b = intent.getBooleanExtra("key_is_need_apply_data", false);
        this.f57475c = (List) intent.getSerializableExtra("key_live_positions");
        this.f57476d = intent.getLongExtra("key_reserve_start_time", 0L);
    }
    ...
    private void zf() {
        ((ReservePreachViewModel) this.mViewModel).f58281g.observe(this, new Observer<RecordDetailForModifyResponse>() { // from class: com.hpbr.bosszhipin.live.boss.reservation.activity.ReservePreachActivity.1
            ...
            public void onChanged(RecordDetailForModifyResponse recordDetailForModifyResponse) {
                if (recordDetailForModifyResponse == null) {
                    oh.g.c(ReservePreachActivity.this);
                    return;
                }
                ReservePreachActivity.this.f57477e = ReservePreachBasicFragment.Wf(null);
                ReservePreachActivity reservePreachActivity = ReservePreachActivity.this;
                reservePreachActivity.Af(xo.e.f146590y5, reservePreachActivity.f57477e, ReservePreachBasicFragment.f57878e, false);
                if (!((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58293s) {
                    recordDetailForModifyResponse.deliverNumLimit = 0;
                    recordDetailForModifyResponse.schoolRecruitInfo = null;
                }
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58282h.postValue(recordDetailForModifyResponse);
            }
        });
        ((ReservePreachViewModel) this.mViewModel).f58288n.observe(this, new Observer<Boolean>() { // from class: com.hpbr.bosszhipin.live.boss.reservation.activity.ReservePreachActivity.2
            @Override // androidx.lifecycle.Observer
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public void onChanged(Boolean bool) {
                if (bool.booleanValue()) {
                    ReservePreachActivity.this.Af(xo.e.Q5, ReservePreachOptionalFragment.Wf(null), ReservePreachOptionalFragment.f57882e, true);
                    ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58296v = true;
                } else {
                    ReservePreachActivity.this.vf(ReservePreachOptionalFragment.f57882e, true);
                    ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58296v = false;
                }
            }
        });
        LiveBus.with("live_campus_boss_reserve_update_time", ip.e.class).observe(this, new Observer<ip.e>() { // from class: com.hpbr.bosszhipin.live.boss.reservation.activity.ReservePreachActivity.3
            @Override // androidx.lifecycle.Observer
            /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
            public void onChanged(ip.e eVar) {
                ...
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58298x = eVar.f123812d;
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).j0(eVar.f123810b);
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).R().atsProjectId = eVar.f123813e;
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).V(eVar.f123811c);
                ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).f58282h.postValue(((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).R());
                if (com.hpbr.bosszhipin.live.util.l.b() == 1) {
                    ((ReservePreachViewModel) ((BaseAwareActivity) ReservePreachActivity.this).mViewModel).Z();
                }
            }
        });
    }
    ...
    protected void onActivityResult(int i11, int i12, @Nullable Intent intent) {
        ...
        if (i11 == 10000) {
            if (intent.getSerializableExtra(com.hpbr.bosszhipin.config.b.U) instanceof PayResult) {
                hp.a.a(((ReservePreachViewModel) this.mViewModel).R() != null ? ((ReservePreachViewModel) this.mViewModel).R().bzpType : Integer.parseInt("2"));
        ...
        switch (i11) {
            ...
            case 13:
                ...
                ReservePreachBasicFragment reservePreachBasicFragment = this.f57477e;
                if (reservePreachBasicFragment != null) {
                    reservePreachBasicFragment.Yf();
                }
                break;
        }
    }
