...
public class z extends com.hpbr.bosszhipin.recycleview.a<ServerJobCardBean, BaseViewHolder> {
    ...
    public void e(BaseViewHolder baseViewHolder, ServerJobCardBean serverJobCardBean, int i11) {
            ...
            while (it.hasNext()) {
                ...
                if (next != null) {
                    if (!TextUtils.isEmpty(next.url) && next.height > 0 && next.width > 0) {
                        ...
                        int i12 = (next.width * iA) / next.height;
                        SimpleDraweeView simpleDraweeView2 = new SimpleDraweeView(this.f84490b);
                        simpleDraweeView2.setLayoutParams(new ViewGroup.LayoutParams(i12, iA));
        ...
        if (serverJobCardBean.isJobInvalid()) {
            ...
            mTextView2.setTextColor(ContextCompat.getColor(this.f84490b, i13));
            mTextView2.setTextSize(1, 14.0f);
            mTextView3.setTextColor(ContextCompat.getColor(this.f84490b, i13));
            mTextView4.setTextColor(ContextCompat.getColor(this.f84490b, i13));
            mTextView6.setTextColor(ContextCompat.getColor(this.f84490b, i13));
            str = "停止招聘";
        } else {
            str = serverJobCardBean.salaryDesc;
            Context context2 = this.f84490b;
            int i14 = di.b.Y;
            mTextView.setTextColor(ContextCompat.getColor(context2, i14));
        ...
        mTextView5.b(serverJobCardBean.distance, 8);
