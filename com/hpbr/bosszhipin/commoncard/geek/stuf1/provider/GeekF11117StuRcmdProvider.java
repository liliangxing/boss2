...
public class GeekF11117StuRcmdProvider extends com.hpbr.bosszhipin.recycleview.a<Geek1117SimilarListBean, BaseViewHolder> {

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static int f38651e = 13091;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final gi.f f38652d;
    ...
    private class CardAdapter extends BaseQuickAdapter<ServerJobCardBean, BaseViewHolder> {
        ...
        class a extends x0 {
            ...
            final /* synthetic */ ServerJobCardBean f38654b;

            a(ServerJobCardBean serverJobCardBean) {
                this.f38654b = serverJobCardBean;
            }

            @Override // com.hpbr.bosszhipin.views.x0
            public void onNoFastClick(View view) {
                ParamBean paramBean = new ParamBean();
                ServerJobCardBean serverJobCardBean = this.f38654b;
                ...
                GeekPageRouter.A(((BaseQuickAdapter) CardAdapter.this).mContext, paramBean, false, GeekF11117StuRcmdProvider.f38651e);
            }
        }
            ...
            if (!LList.isEmpty(serverJobCardBean.jobLabels)) {
                for (String str : serverJobCardBean.jobLabels) {
                    if (!TextUtils.isEmpty(str)) {
                        flowLayout.addView(GeekF11117StuRcmdProvider.this.u(this.mContext, str));
                    }
                }
            }
    ...
    class a extends x0 {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ Geek1117SimilarListBean f38656b;

        a(Geek1117SimilarListBean geek1117SimilarListBean) {
            this.f38656b = geek1117SimilarListBean;
        }

        @Override // com.hpbr.bosszhipin.views.x0
        public void onNoFastClick(View view) {
            GeekF11117StuRcmdProvider.this.f38652d.L5(this.f38656b);
            SimpleApiRequest.GET(v30.a.S5).addParam("type", (Object) 5).addParam("uuid", this.f38656b.uuid).addParam("action", (Object) 2).addParam("securityId", this.f38656b.securityId).execute();
        }
    }
    ...
    class b extends x0 {
        ...
        @Override // com.hpbr.bosszhipin.views.x0
        public void onNoFastClick(View view) {
            new k0(GeekF11117StuRcmdProvider.this.f84490b, this.f38658b).g();
        }
    }

    public GeekF11117StuRcmdProvider(gi.f fVar) {
        this.f38652d = fVar;
    }
    ...
    public void e(BaseViewHolder baseViewHolder, Geek1117SimilarListBean geek1117SimilarListBean, int i11) {
        ...
        if (!TextUtils.isEmpty(geek1117SimilarListBean.title)) {
            mTextView.setText(geek1117SimilarListBean.title);
        }
        RecyclerViewAtViewPager2 recyclerViewAtViewPager2 = (RecyclerViewAtViewPager2) baseViewHolder.getView(di.d.I2);
        imageView.setOnClickListener(new a(geek1117SimilarListBean));
        CardAdapter cardAdapter = new CardAdapter(geek1117SimilarListBean.jobList);
        recyclerViewAtViewPager2.setAdapter(cardAdapter);
        ServerButtonBean serverButtonBean = geek1117SimilarListBean.button;
        if (serverButtonBean == null || TextUtils.isEmpty(serverButtonBean.url)) {
            cardAdapter.removeAllFooterView();
        } else {
            cardAdapter.addFooterView(t(geek1117SimilarListBean.button.url), LList.getCount(geek1117SimilarListBean.jobList), 0);
        }
        SimpleApiRequest.GET(v30.a.S5).addParam("type", (Object) 5).addParam("uuid", geek1117SimilarListBean.uuid).addParam("action", (Object) 1).addParam("securityId", geek1117SimilarListBean.securityId).execute();
    }
}