...
import com.hpbr.bosszhipin.commoncard.boss.provider.v;
import com.hpbr.bosszhipin.commoncard.boss.provider.w;
...
public class ResumeMultiCardF3ListAdapter extends BaseMultipleItemRvAdapter<BossBaseCardBean, BaseViewHolder> {
    public ResumeMultiCardF3ListAdapter() {
        this(null);
    }
    ...
    public void registerItemProvider() {
        v(new EmptyProvider(), new y(), new w(), new v(), new a0());
    }

    public ResumeMultiCardF3ListAdapter(@Nullable List<BossBaseCardBean> list) {
        super(list);
    }
}