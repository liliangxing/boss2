...
public class StuF1MixSelectParams extends BaseEntity {
    ...
    public static StuF1MixSelectParams obj() {
        return new StuF1MixSelectParams();
    }
    ...
    public StuF1MixSelectParams setExpectType(long j11) {
        this.expectType = j11;
        return this;
    }

    public StuF1MixSelectParams setJobIntent(JobIntentBean jobIntentBean) {
        this.mCurExpectJobForGeek = jobIntentBean;
        return this;
    }

    public StuF1MixSelectParams setSelectCityList(List<LevelBean> list) {
        this.mSelectCityList = list;
        return this;
    }

    public StuF1MixSelectParams setSelectDistrictData(LevelBean levelBean) {
        this.mSelectedDistrictData = levelBean;
        return this;
    }

    public StuF1MixSelectParams setSelectSubwayData(LevelBean levelBean) {
        this.mSelectedSubwayData = levelBean;
        return this;
    }

    public StuF1MixSelectParams setSortType(int i11) {
        this.sortType = i11;
        return this;
    }
}