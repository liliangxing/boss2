...
public class EmptyChatFactory implements xn.e<ChatBean> {
    ...
    public BaseChatGroupHolder a(Context context, ViewGroup viewGroup) {
        return new EmptyChatGroupHolder(context, LayoutInflater.from(context).inflate(ba.h.f4249eh, (ViewGroup) null));
    }
