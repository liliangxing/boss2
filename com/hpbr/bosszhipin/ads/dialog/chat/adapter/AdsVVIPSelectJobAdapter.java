...
public class AdsVVIPSelectJobAdapter extends BaseQuickAdapter<JobBean, BaseViewHolder> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected JobBean f20838b;

    public AdsVVIPSelectJobAdapter(@Nullable List<JobBean> list) {
    ...
    public void i(JobBean jobBean) {
        this.f20838b = jobBean;
    }
}