.class Lcom/bszp/kernel/chat/db/MessageDao_Impl$4;
...
.method constructor <init>(Lcom/bszp/kernel/chat/db/MessageDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/bszp/kernel/chat/db/MessageDao_Impl$4;->this$0:Lcom/bszp/kernel/chat/db/MessageDao_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bszp/kernel/chat/db/MessageDao_Impl$4;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/bszp/kernel/chat/db/entity/MessageEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `Message` SET `id` = ?,`mid` = ?,`friendId` = ?,`friendSource` = ?,`friendType` = ?,`mediaType` = ?,`msgType` = ?,`securityId` = ?,`sender` = ?,`time` = ?,`cmid` = ?,`smid` = ?,`templateId` = ?,`status` = ?,`recStatus` = ?,`badged` = ?,`isShow` = ?,`extend` = ?,`content` = ?,`headTitle` = ?,`bizType` = ?,`bizId` = ?,`taskId` = ?,`flag` = ?,`version` = ?,`extMsg` = ?,`extMapField` = ?,`extStr` = ?,`extStr2` = ?,`extStr3` = ?,`data` = ? WHERE `id` = ?"
