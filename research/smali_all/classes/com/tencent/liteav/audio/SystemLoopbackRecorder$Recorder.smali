...
.method private static a(Landroid/media/projection/MediaProjection;III)Landroid/media/AudioRecord;
    ...
    .line 2
    invoke-static {v1, p0}, Lcom/tencent/liteav/audio/h;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    const/16 v2, 0xe

    .line 3
    invoke-static {v1, v2}, Lcom/tencent/liteav/audio/h;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;

    .line 4
    invoke-static {v1}, Lcom/tencent/liteav/audio/i;->a(Landroid/media/AudioPlaybackCaptureConfiguration$Builder;)Landroid/media/AudioPlaybackCaptureConfiguration;
    ...
    .line 12
    invoke-static {v8, v3}, Lcom/sdk/nebulamediakit/audio/recorder/b;->a(Landroid/media/AudioRecord$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioRecord$Builder;

    move-result-object v8

    .line 13
    invoke-static {v8, v6}, Lcom/sdk/nebulamediakit/audio/recorder/c;->a(Landroid/media/AudioRecord$Builder;I)Landroid/media/AudioRecord$Builder;

    move-result-object v6

    .line 14
    invoke-static {v6, v1}, Lcom/tencent/liteav/audio/j;->a(Landroid/media/AudioRecord$Builder;Landroid/media/AudioPlaybackCaptureConfiguration;)Landroid/media/AudioRecord$Builder;

    move-result-object v6

    .line 15
    invoke-static {v6}, Lcom/sdk/nebulamediakit/audio/recorder/d;->a(Landroid/media/AudioRecord$Builder;)Landroid/media/AudioRecord;
    ...
    :try_end_78
    .catchall {:try_start_48 .. :try_end_78} :catchall_79
...
.method public startRecording(Landroid/media/projection/MediaProjection;III)I
    ...
    .line 7
    invoke-static {v1, v2}, Lcom/tencent/liteav/audio/k;->a(Landroid/media/AudioManager;I)V
    :try_end_9
