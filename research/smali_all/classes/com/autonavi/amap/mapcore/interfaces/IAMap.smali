...
.method public abstract add3DModelTileOverlay(Lcom/amap/api/maps/model/amap3dmodeltile/AMap3DModelTileOverlayOptions;)Lcom/amap/api/maps/model/amap3dmodeltile/AMap3DModelTileOverlay;
...
.method public abstract addAMapAppResourceListener(Lcom/amap/api/maps/AMap$AMapAppResourceRequestListener;)V
.end method
...
.method public abstract addContourLineOverlay(Lcom/amap/api/col/3sl/et;)Lcom/amap/api/col/3sl/u3;
.end method
...
.method public abstract addGLTFOverlay(Lcom/amap/api/maps/model/GLTFOverlayOptions;)Lcom/amap/api/maps/model/GLTFOverlay;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract addHeatMapGridLayer(Lcom/amap/api/maps/model/HeatMapGridLayerOptions;)Lcom/amap/api/maps/model/HeatMapGridLayer;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract addMVTTileOverlay(Lcom/amap/api/maps/model/MVTTileOverlayOptions;)Lcom/amap/api/maps/model/MVTTileOverlay;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract addPoiFilter(Lcom/amap/api/maps/model/PoiFilter;)V
.end method
...
.method public abstract addSignleClickInterceptorListener(Lcom/amap/api/maps/AMap$SignleClickInterceptorListener;)V
.end method
...
.method public abstract getMapScreenShot(Lcom/amap/api/maps/AMap$OnMapScreenShotListener;Z)V
.end method

.method public abstract getMapScreenShot(Lcom/amap/api/maps/AMap$OnMapScreenShotListener;ZLandroid/os/Handler;)V
.end method
...
.method public abstract getNativeEngineID()I
.end method

.method public abstract getNativeMapController()J
.end method

.method public abstract getOverlayBoundRect(Ljava/lang/String;)Lcom/amap/api/maps/model/LatLngBounds;
.end method
...
.method public abstract getTerrainApprovalNumber()Ljava/lang/String;
.end method
...
.method public abstract hideBuildings(Ljava/util/List;)I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
...
.method public abstract isUseForNavi()Z
.end method
...
.method public abstract removeAMapAppResourceListener(Lcom/amap/api/maps/AMap$AMapAppResourceRequestListener;)V
.end method
...
.method public abstract removeSignleClickInterceptorListener(Lcom/amap/api/maps/AMap$SignleClickInterceptorListener;)V
.end method
...
.method public abstract setCurrentLocation(Lcom/amap/api/maps/model/LatLng;)V
.end method

.method public abstract setCustomMapStyle(Lcom/amap/api/maps/model/CustomMapStyleOptions;)V
.end method

.method public abstract setCustomMapStyle(Lcom/amap/api/maps/model/CustomMapStyleOptions;Lcom/amap/api/maps/AMap$OnCustomMapStyleListener;)V
.end method
...
.method public abstract setCustomScreenDensity(F)V
.end method
...
.method public abstract setMapOptRecordState(Z)V
.end method
...
.method public abstract setTrafficStyleWithTexture([BLcom/amap/api/maps/model/MyTrafficStyle;)V
.end method

.method public abstract setTrafficStyleWithTextureData([B)V
.end method

.method public abstract setUseForNavi(Z)V
.end method
...
.method public abstract showHideBuildings(I)V
.end method
