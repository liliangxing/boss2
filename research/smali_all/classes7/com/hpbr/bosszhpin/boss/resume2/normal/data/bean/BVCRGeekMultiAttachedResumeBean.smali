.class public Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;
.super Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BaseBVCRItemBean;
.source "SourceFile"


# static fields
.field private static final serialVersionUID:J = -0x33c8828314e3773L


# instance fields
.field public geekBean:Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;

.field public hasVideoResumeExposure:Z
...
.method public constructor <init>(Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;Z)V
    ...
    .line 5
    .line 6
    iput-object p1, p0, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->geekBean:Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;

    .line 7
    .line 8
    iput-boolean p2, p0, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isQuickHandle:Z
...
.method private addSort0(Ljava/util/List;)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isResumeChatValid()Z
    ...
    .line 6
    .line 7
    iget-object v0, p0, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->geekBean:Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;
    ...
    .line 14
    :cond_d
    invoke-virtual {p0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isDesignGreetValid()Z
    ...
    .line 27
    :cond_1a
    invoke-virtual {p0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isVideoResumeValid()Z
...
.method public static mock(Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;)Lcom/hpbr/bosszhpin/boss/resume/adapter/entity/BossViewResumeMultiAttachmentEntity;
    ...
    .line 6
    .line 7
    invoke-static {}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->mockServerResumeMultiVideoInfo()Lnet/bosszhipin/api/bean/ServerResumeMultiVideoInfo;
...
.method public getGeekSUId()Ljava/lang/String;
    .registers 2
...
.method public isDeliveryContinue()Z
    .registers 2
    ...
    iget-object v0, v0, Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;->deliveryGeekInfo:Lnet/bosszhipin/api/bean/ServerDeliveryGeekInfo;

    if-eqz v0, :cond_10

    invoke-virtual {v0}, Lnet/bosszhipin/api/bean/ServerDeliveryGeekInfo;->isContinue()Z
...
.method public isDeliveryImmediateChat()Z
    .registers 2
    ...
    invoke-virtual {v0}, Lnet/bosszhipin/api/bean/ServerDeliveryGeekInfo;->isImmediateChat()Z
...
.method public isDeliveryUnfit()Z
    .registers 2
    ...
    invoke-virtual {v0}, Lnet/bosszhipin/api/bean/ServerDeliveryGeekInfo;->isUnfit()Z
...
.method public isResumeChatValid()Z
    ...
    iget-boolean v0, p0, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isQuickHandle:Z
...
.method public isSecretGeekInfoSuccess()Z
    ...
    invoke-virtual {v0}, Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;->isSecretGeekInfoSuccess()Z
...
.method public obtainItemList()Ljava/util/List;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->isMultiAttachmentValid()Z
    ...
    .line 11
    .line 12
    iget-object v1, p0, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->geekBean:Lcom/hpbr/bosszhipin/module/login/entity/GeekBean;
    ...
    .line 18
    .line 19
    invoke-direct {p0, v0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->addSort1(Ljava/util/List;)V
    ...
    .line 23
    :cond_16
    invoke-direct {p0, v0}, Lcom/hpbr/bosszhpin/boss/resume2/normal/data/bean/BVCRGeekMultiAttachedResumeBean;->addSort0(Ljava/util/List;)V
